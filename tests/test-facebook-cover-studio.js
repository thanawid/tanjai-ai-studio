...
console.log(JSON.stringify({version:'12.6.9',coverModes:2,facebookFivePhotoPack:true,fullCoverDownload:true,freeCoverPosition:true,coverFitModes:2,simpleBandPresets:true,templateGoldDecor:true,phoneAsTyped:true,aiCaption:true,noPurposeField:true,officialBrandCover:true,status:'PASS'},null,2));

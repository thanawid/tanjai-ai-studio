...
assert.match(app, /id="album-storyMode"/);
assert.match(app, /value="split-main"/);
assert.match(app, /value="separate"/);
assert.match(album, /async function processStoryGrid/);
assert.match(album, /facebook_story_grid_/);

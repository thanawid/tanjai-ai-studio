...
console.log(JSON.stringify({version:'11.6.6',uploadMany:true,renderQueue:true,selectedClipExport:true,zipExport:true,downloadOnly:true,status:'PASS'},null,2));

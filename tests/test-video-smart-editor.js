...
console.log(JSON.stringify({version:'12.3.0',uploadMany:true,renderQueue:true,selectedClipExport:true,zipExport:true,downloadOnly:true,status:'PASS'},null,2));

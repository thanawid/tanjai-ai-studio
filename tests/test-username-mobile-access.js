...
assert.strictEqual(pkg.version, "11.6.4");
assert.match(index, /V11\.6\.4/);
...
console.log(JSON.stringify({version:"11.6.4",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.strictEqual(pkg.version, "12.2.0");
assert.match(index, /V12\.2\.0/);
assert.match(index, /v=12\.2\.0/);
...
console.log(JSON.stringify({version:"12.2.0",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.match(index, /V11\.0\.0/);
assert.match(index, /v=11\.0\.0/);
...
console.log(JSON.stringify({version:"11.0.0",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

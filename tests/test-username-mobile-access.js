...
assert.strictEqual(pkg.version, "12.7.2");
...
console.log(JSON.stringify({version:"12.7.2",hiddenVersion:true,hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

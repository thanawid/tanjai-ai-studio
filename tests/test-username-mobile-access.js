...
assert.strictEqual(pkg.version, "11.6.6");
assert.match(index, /V11\.6\.6/);
assert.match(index, /v=11\.2\.0/);
...
console.log(JSON.stringify({version:"11.6.6",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

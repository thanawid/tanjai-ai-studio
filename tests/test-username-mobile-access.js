...
assert.strictEqual(pkg.version, "11.1.0");
assert.match(index, /V11\.1\.0/);
assert.match(index, /v=11\.1\.0/);
...
console.log(JSON.stringify({version:"11.1.0",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

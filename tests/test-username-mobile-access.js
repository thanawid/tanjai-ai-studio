...
assert.strictEqual(pkg.version, "9.8.3");
assert.match(index, /V9\.8\.3/);
assert.match(index, /v=9\.8\.3/);
...
console.log(JSON.stringify({version:"9.8.3",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.strictEqual(pkg.version, "11.6.3");
assert.match(index, /V11\.6\.3/);
...
console.log(JSON.stringify({version:"11.6.3",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

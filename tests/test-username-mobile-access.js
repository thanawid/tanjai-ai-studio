...
assert.strictEqual(pkg.version, "12.6.9");
...
console.log(JSON.stringify({version:"12.6.9",hiddenVersion:true,hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

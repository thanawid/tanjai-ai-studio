...
assert.match(index, /V10\.1\.0/);
assert.match(index, /v=10\.1\.0/);
...
console.log(JSON.stringify({version:"10.1.0",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

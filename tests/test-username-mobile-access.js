...
assert.strictEqual(pkg.version, "11.2.0");
assert.match(index, /V11\.2\.0/);
...
console.log(JSON.stringify({version:"11.2.0",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

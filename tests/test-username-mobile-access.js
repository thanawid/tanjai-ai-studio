...
assert.strictEqual(pkg.version, "11.6.2");
assert.match(index, /V11\.6\.2/);
...
console.log(JSON.stringify({version:"11.6.2",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.strictEqual(pkg.version, "12.2.1");
assert.match(index, /V12\.2\.1/);
assert.match(index, /v=12\.2\.1/);
...
console.log(JSON.stringify({version:"12.2.1",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.strictEqual(pkg.version, "10.0.1");
assert.match(index, /V10\.0\.1/);
assert.match(index, /v=10\.0\.1/);
...
console.log(JSON.stringify({version:"10.0.1",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

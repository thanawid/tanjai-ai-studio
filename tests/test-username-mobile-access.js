...
assert.strictEqual(pkg.version, "11.6.7");
assert.match(index, /V11\.6\.7/);
...
console.log(JSON.stringify({version:"11.6.7",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

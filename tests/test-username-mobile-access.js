...
assert.strictEqual(pkg.version, "11.6.1");
assert.match(index, /V11\.6\.1/);
...
console.log(JSON.stringify({version:"11.6.1",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

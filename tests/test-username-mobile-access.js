...
assert.strictEqual(pkg.version, "12.6.8");
...
console.log(JSON.stringify({version:"12.6.8",hiddenVersion:true,hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

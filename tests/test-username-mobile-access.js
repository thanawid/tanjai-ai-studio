...
assert.strictEqual(pkg.version, "11.6.5");
assert.match(index, /V11\.6\.5/);
...
console.log(JSON.stringify({version:"11.6.5",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

...
assert.strictEqual(pkg.version, "9.9.6");
assert.match(index, /V9\.9\.6/);
assert.match(index, /v=9\.9\.6/);
...
console.log(JSON.stringify({version:"9.9.6",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

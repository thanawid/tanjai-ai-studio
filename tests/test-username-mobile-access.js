...
assert.strictEqual(pkg.version, "12.6.6");
...
console.log(JSON.stringify({version:"12.6.6",hiddenVersion:true,hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

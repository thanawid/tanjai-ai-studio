...
assert.strictEqual(pkg.version, "11.6.8");
assert.match(index, /V11\.6\.8/);
...
console.log(JSON.stringify({version:"11.6.8",hiddenSpecialist:true,proofreadNav:true,status:"PASS"},null,2));

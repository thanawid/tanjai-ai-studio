...
assert.match(app, /version: "12\.2\.1"/);
...
console.log(JSON.stringify({ version: "12.2.1", oneRepository: true, internalVideoPage: true, renderApiBridge: true, status: "PASS" }, null, 2));

...
assert.match(app, /version: "12\.5\.0"/);
...
console.log(JSON.stringify({version:"12.5.0",oneRepository:true,embeddedVideoModule:true,sharedShell:true,renderApiBridge:true,status:"PASS"},null,2));

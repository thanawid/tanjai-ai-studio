...
assert.match(index,/ui\.js\?v=12\.6\.3-context-ai/);
...
console.log(JSON.stringify({version:'12.7.2',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

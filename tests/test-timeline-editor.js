...
assert.match(index,/ui\.js\?v=12\.5\.4-post-ready/);
...
console.log(JSON.stringify({version:'12.5.4',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

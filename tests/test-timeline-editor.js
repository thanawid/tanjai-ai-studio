...
assert.match(index,/ui\.js\?v=12\.5\.5-post-sparse/);
...
console.log(JSON.stringify({version:'12.5.5',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

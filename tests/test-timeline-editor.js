...
assert.match(index,/ui\.js\?v=12\.4\.0/);
...
console.log(JSON.stringify({version:'12.4.0',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

...
assert.match(index,/ui\.js\?v=12\.5\.2-post-polish/);
...
console.log(JSON.stringify({version:'12.5.2',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

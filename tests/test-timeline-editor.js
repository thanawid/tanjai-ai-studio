...
assert.match(index,/ui\.js\?v=12\.5\.3-post-creative/);
...
console.log(JSON.stringify({version:'12.5.3',embeddedCreator:true,footageDownloadOnly:true,unifiedStudio:true,status:'PASS'},null,2));

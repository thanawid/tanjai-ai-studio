...
## v8.2.2 Color Dropdown Only

- คงธีมเว็บ สีเว็บ เมนู โครงสร้าง ฟังก์ชัน และหน้าแรกเหมือน v8.2.2
...
## V8.2.2 — Command Palette + FAB Quick Menu + Output Panel Stabilize

- รวม Command Palette, FAB Quick Menu และ Mobile Bottom Tab Bar
- กด Ctrl + K เพื่อค้นหาคำสั่งเร็ว เช่น สร้างภาพ / โพสต์ / วิดีโอ / เสียงพากย์
- เพิ่มปุ่มลอยมุมขวาล่างสำหรับสร้างงานเร็ว
- เพิ่มเมนูล่างบนมือถือ
- ปรับกล่องผลลัพธ์ด้านขวาไม่ให้หัวข้อโดนปุ่มบีบจนตกบรรทัด
- ย่อชื่อปุ่มใน Output Panel ให้สั้นขึ้น
- คงธีม เมนู หน้าแรก และระบบหลักจาก V8.2.2


## V8.2.2 — Clean Actions

- ลดปุ่มในกล่องผลลัพธ์ฝั่งขวาให้เหลือเฉพาะ Prompt / พร้อมใช้ / คัดลอก + เปิด GPT
- ซ่อนแถวปุ่มปลายทางซ้ำ เช่น เปิด GPT / เปิด Canva ใต้กล่องผลลัพธ์
- ย่อ FAB Quick Menu ให้เล็กลง เหลือ ภาพ / โพสต์ / วิดีโอ / GPT
- เพิ่มการคลิกนอก FAB เพื่อปิดเมนูอัตโนมัติ
- คง Command Palette, หน้าแรก, เมนูหลัก และระบบ V8.2.2 เดิมไว้


## V8.2.2 — Output Meaning Fix

- แก้ความหมายหัวกล่องผลลัพธ์ฝั่งขวาให้ไม่สับสน
- ค่าเริ่มต้นใช้คำว่า “ผลลัพธ์สร้างภาพ”
- โหมด Prompt แสดงเป็น “Prompt สำหรับสร้างภาพ”
- โหมดส่ง GPT แสดงเป็น “คำสั่งส่งเข้า GPT”
- เปลี่ยนปุ่ม “คัดลอก + เปิด GPT” เป็น “ส่งเข้า GPT”
- ลดความรู้สึกว่าทุกอย่างคือ “คำสั่งพร้อมใช้งาน” ทั้งที่ยังไม่ได้เลือกโหมด
- คง Command Palette, FAB, Mobile Tabbar และระบบเดิมจาก V8.2.1

...
## v8.2 Color Dropdown Only

- คงธีมเว็บ สีเว็บ เมนู โครงสร้าง ฟังก์ชัน และหน้าแรกเหมือน v8.2
...
## V8.2 — Command Palette + FAB Quick Menu + Output Panel Stabilize
...
- คงธีม เมนู หน้าแรก และระบบหลักจาก V8.2

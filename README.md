...
เวอร์ชันฐาน: V9.8.3 Stable Foundation
...
> หมายเหตุ: ชุดเทสต์ในเวอร์ชันนี้ปรับให้ตรวจฐานปัจจุบัน ได้แก่ version/cache, auto specialist หลังบ้าน, proofread layer, AI integration และ smoke test หลักของระบบ

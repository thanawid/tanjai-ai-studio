...
function buildPostPrompt(data = {}, options = {}){
  ...
  const modeRules = /ให้ AI วิเคราะห์/.test(mode)
    ? `วิเคราะห์ก่อนว่างานเกิดขึ้นแล้วหรือกำลังจะเกิด และเป้าหมายคือเชิญชวน แจ้งข่าว สรุปผล ให้ความรู้ หรือยังเป็นเพียงข้อมูลตั้งต้น จากนั้นเลือกชิ้นงานที่เหมาะที่สุด
ห้ามขึ้นต้นด้วยสถานะการทำงาน ชื่อโมเดล หรือคำว่า “ชิ้นงานที่เลือก” ให้ส่งตัวผลงานทันที
เลือก “ประเภทงานเขียน” จากปลายทางใช้งานเท่านั้น และใช้ options.purpose กำหนดเนื้อหาว่าเป็นเชิญชวนก่อนงาน สรุปกิจกรรม แจ้งข่าว ให้ความรู้ หรือรายงานผล ห้ามเปลี่ยนวัตถุประสงค์ให้กลายเป็นชิ้นงานคนละชนิด`
            ...
            : /บทพากย์|ทำเสียง/.test(mode)
              ...
              : /ข่าวประชาสัมพันธ์/.test(mode)
                ...
                : /แคปชั่น YouTube|Reels|TikTok/.test(mode)
                  ...
                  : /ครบชุด/.test(mode)
                    ? "สร้าง 4 ส่วนที่ไม่คัดลอกกันตรง ๆ: โพสต์ Facebook ข่าวประชาสัมพันธ์ บทพากย์ และแคปชั่นคลิป ห้ามส่ง Production Pack หรือ Prompt สำหรับเครื่องมือวิดีโอ"
...
- คำว่า “โครงการ” หรือ “กิจกรรม” เพียงอย่างเดียว ไม่ได้แปลว่าเป็นงานเชิญชวนและไม่ได้แปลว่าจัดเสร็จแล้ว

...
<div class="section-title"><b>4</b><h4>การปกป้องภาพจริง</h4></div>
  ...
  // Results
  $("#imageResult").innerHTML = TANJAI.resultShell("image", "ผลลัพธ์สร้างภาพ", "เลือกว่าจะใช้เป็น Prompt หรือส่งให้ทันใจ GPT สร้างภาพจริง", "imageOut", `<button class="btn secondary" data-image-viewmode="prompt">ดู Prompt</button><button class="btn secondary" data-image-viewmode="gpt">ส่ง GPT</button>`);

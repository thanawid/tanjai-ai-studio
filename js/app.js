  ...
  $("#albumForm").innerHTML = `
    ...
    <div class="form-section"><div class="section-title"><b>3</b><h4>ตั้งค่าชุดภาพ</h4></div>
      <div class="form-grid">
        ...
        <label>รูปแบบตัวอย่างโพสต์<select id="album-previewLayout"><option value="auto" selected>อัตโนมัติ — เลือกจากสัดส่วนและจำนวนภาพ</option><option value="cover-top">ภาพปกใหญ่ด้านบน + ภาพรองด้านล่าง</option><option value="cover-left">ภาพปกใหญ่ด้านซ้าย + ภาพรองด้านขวา</option><option value="grid">ตารางภาพสมดุล</option><option value="mobile-focus">Mobile-first: ปกแนวตั้ง + ภาพรองจัตุรัส</option></select></label>
        ...
        <label>Pro Frame (กรอบตามตัวอย่าง)<select id="album-proFrame"><option value="Gold Luxury" selected>Gold Luxury (ขอบทองหรูหรา)</option><option value="None">ไม่มีกรอบพิเศษ</option><option value="Modern Neon">Modern Neon (ขอบนีออนเรืองแสง)</option><option value="Bold Corporate">Bold Corporate (ขอบหนาสีแบรนด์)</option></select><small>ใช้กับภาพปกเป็นหลัก ส่วนภาพรองจะลดน้ำหนักกรอบให้อัตโนมัติ</small></label>

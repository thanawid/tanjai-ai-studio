...
// Render forms
  ...
  $("#imageForm").innerHTML = TANJAI.field("image") + `
    <div class="form-section creative-quality-wrap-v91"><div class="section-title"><b>2</b><h4>ประเภทเนื้อหา + แนวภาพ</h4></div>
      <p class="mini-note">เลือกประเภทเนื้อหาและแนวภาพหลัก เพื่อให้ระบบรู้ว่างานนี้ควรถามข้อมูลอะไร และควรเขียน Prompt ในสไตล์ใด โดยไม่บังคับวันเวลาในงานที่ไม่จำเป็น</p>
      <div class="form-grid">
        ...
        <label>แนวภาพหลัก / Visual Preset<select id="image-visualPreset">${opts(toolOptions.visualPresets)}</select><small>เลือกแนวหลัก 1 อย่าง เพื่อไม่ให้ Prompt หลายทิศ</small></label>
        <label class="full">ตัวเสริมภาพ / Style Modifier<select id="image-styleModifiers" class="style-modifier-select-v974" multiple size="6">${opts(toolOptions.styleModifiers)}</select><small>เลือกได้ 1–3 อย่าง เช่น อ่านง่ายบนมือถือ / เว้นพื้นที่ข้อความ / แสงภาพยนตร์</small></label>

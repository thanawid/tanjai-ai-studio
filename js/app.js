...
$("#postResult").innerHTML = TANJAI.readyOutputShell("post", "Prompt โพสต์ — สั่งทำทันที", "คัดลอกแล้วให้ AI เขียนโพสต์ทันที พร้อม Prompt สำหรับแก้/คุยต่อ", "postOut");
  ...
  TANJAI.activateMCMode = function(){
    ...
    setTimeout(() => {
      ...
      if(title && !title.value.trim()) title.value = "ชื่องาน / พิธีการ";
      if(detail && (!detail.value.trim() || detail.value === "ยังไม่ได้ระบุรายละเอียดเพิ่มเติม")){
        detail.value = "กรอกกำหนดการหรือลำดับพิธี เช่น กล่าวต้อนรับ เชิญประธาน กล่าวรายงาน เปิดงาน มอบรางวัล ถ่ายภาพร่วมกัน และปิดงาน";
      }
      if(extra && !extra.value.trim()){
        extra.value = "เน้นภาษาไทยสุภาพ อ่านออกเสียงง่าย มีคำเชิญประธาน คำเชื่อมช่วง และเวอร์ชันย่อสำหรับพิธีกรถืออ่าน";
      }
  ...
  // v8.9.3 Command Palette + MC Workspace Shortcut
  TANJAI.quickActions = [

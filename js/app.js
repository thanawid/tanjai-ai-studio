...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const toolOptions = {
    ...
    contentTypes: ["ให้ AI วิเคราะห์เอง","ประกาศ / แจ้งข่าว","ข่าวประชาสัมพันธ์ / สรุปกิจกรรม","เชิญร่วมกิจกรรม","งานประชุม / งานพิธี","โครงการ / อบรม","โปรโมทเพลง / ศิลปิน","สินค้า / บริการ","คำคม / แคปชั่น","ภาพคอนเซ็ปต์ / ภาพศิลป์","มาสคอต / คาแรกเตอร์","โลโก้ / แบรนด์"],
    visualPresets: ["ให้ AI เลือกตามงาน","โปสเตอร์ประชาสัมพันธ์ราชการ","ข่าวประชาสัมพันธ์แบบสรุปกิจกรรม","โปสเตอร์สถาบันการศึกษา","PR Recap / Photo Grid Poster","Social Media Modern","Thai PR Premium","ภาพจริงแนวข่าวประชาสัมพันธ์","Infographic Clean","Minimal Clean","Luxury / Premium","3D Premium","ภาพการ์ตูน 2D","มาสคอต 3D","ภาพแฟนตาซี","โปสเตอร์หนัง / Cinematic Poster","ภาพสินค้า / Commercial Product","เพลง / ศิลปิน / Cover Art","ภาพคอนเซ็ปต์ / Mood Visual"],
    styleModifiers: ["อ่านง่ายบนมือถือ","ตัวหนังสือใหญ่","เว้นพื้นที่ข้อความ","โทนอบอุ่น","โทนสดใส","โทนเข้มจริงจัง","แสงภาพยนตร์","มีมิติ 3D เบา ๆ","เน้นภาพจริง","เน้นข้อมูล / ตัวเลข","กริดภาพหลายช่อง","มีบล็อกสรุปข้อมูล","ภาพบุคคลเด่นด้านบน","เหมาะกับหน่วยงานราชการ","เหมาะกับโซเชียลไวรัล"],
    ...
    workContexts: ["ให้ AI ช่วยเลือกจากรายละเอียด","Thai PR Premium","โปสเตอร์ประชาสัมพันธ์ไทยสีสด","แจ้งข่าว / ประกาศ","ข่าวประชาสัมพันธ์ / สรุปกิจกรรม","สถาบันการศึกษา / กิจกรรมนักเรียน","เชิญชวน / ประชาสัมพันธ์","โปรโมท / แคมเปญ / ขายผลงาน","โปรโมทเพลง / ผลงานสร้างสรรค์","ให้ความรู้ / Infographic","ขั้นตอนบริการ / วิธีใช้งาน","สรุปกิจกรรม / รายงานผล","งานพิธี / งานบุญ / งานชุมชน","อบรม / ประชุม / สัมมนา","ขอบคุณ / แสดงความยินดี / อวยพร","รณรงค์ / สร้างความตระหนัก","ไว้อาลัย / สุภาพ / ลดสี","อื่น ๆ"],
    imageTypes: ["ให้ AI ช่วยเลือกตามบริบท","โพสต์โซเชียล","โปสเตอร์ประชาสัมพันธ์","โปสเตอร์ข่าวประชาสัมพันธ์","ภาพสรุปกิจกรรมหลายภาพ","อินโฟกราฟิก","ภาพแน่นข้อมูล","ภาพอ่านง่าย","ปก / Cover","ปกเพลง / โปรโมทเพลง","ภาพเชิญชวนกิจกรรม","ภาพแจ้งข่าว","ภาพสรุปกิจกรรม","ชุดภาพโพสต์ Facebook","ภาพแนวนอน / แบนเนอร์","ภาพไว้อาลัย / สุภาพ","อื่น ๆ"],
    ...
    imageSpecialists: ["ให้ AI เลือกตามงาน","AI Poster Creative Director","AI PR News Designer","AI Event Recap Designer","AI Education Poster Designer","AI Infographic Planner","AI Character Visual Designer","AI Cinematic Cover Director"]
  };
...
// Render forms
  ...
  $("#imageForm").innerHTML = TANJAI.field("image") + `
    <div class="form-section simple-smart-section-v98 creative-quality-wrap-v91">
      <div class="section-title"><b>2</b><h4>เลือกแนวภาพ + ผู้เชี่ยวชาญ AI</h4></div>
      <p class="mini-note">เลือกแค่แนวหลักและปล่อยให้ AI เฉพาะทางรับหน้าที่ต่อได้เลย ถ้าไม่แน่ใจ ให้ปล่อยเป็น “ให้ AI เลือกตามงาน” ทั้งสองช่อง</p>
      <div class="form-grid">
        <label>ผู้เชี่ยวชาญ AI<select id="image-specialist">${opts(toolOptions.imageSpecialists)}</select><small>แยกหน้าที่ให้ชัด เช่น ข่าว PR / สรุปกิจกรรม / อินโฟกราฟิก / ปกผลงาน</small></label>
        <label>แนวภาพหลัก / Visual Preset<select id="image-visualPreset">${opts(toolOptions.visualPresets)}</select><small>นี่คือสไตล์ภาพ ไม่ใช่ข้อความที่จะพิมพ์บนภาพ</small></label>
        <div class="full preset-wrap compact-preset-wrap-v98">
          ...
          <div class="preset-row creative-preset-row-v91 market-preset-row-v98">
            ...
            <button type="button" class="chip-btn" data-v98-visual="ข่าวประชาสัมพันธ์แบบสรุปกิจกรรม" data-v91-context="ข่าวประชาสัมพันธ์ / สรุปกิจกรรม" data-v91-type="ภาพสรุปกิจกรรมหลายภาพ" data-v983-specialist="AI Event Recap Designer">ข่าวสรุปกิจกรรม</button>
            <button type="button" class="chip-btn" data-v98-visual="โปสเตอร์สถาบันการศึกษา" data-v91-context="สถาบันการศึกษา / กิจกรรมนักเรียน" data-v91-type="โปสเตอร์ข่าวประชาสัมพันธ์" data-v983-specialist="AI Education Poster Designer">สถาบันศึกษา</button>
            <button type="button" class="chip-btn" data-v98-visual="PR Recap / Photo Grid Poster" data-v91-context="ข่าวประชาสัมพันธ์ / สรุปกิจกรรม" data-v91-type="ภาพสรุปกิจกรรมหลายภาพ" data-v983-specialist="AI Event Recap Designer">Photo Grid PR</button>
            ...
            <button type="button" class="chip-btn" data-v98-visual="Infographic Clean" data-v91-context="ให้ความรู้ / Infographic" data-v91-type="อินโฟกราฟิก" data-v983-specialist="AI Infographic Planner">Infographic</button>
          </div>
        </div>
      </div>
...
$("#albumForm").innerHTML = `
  ...
  $("#videoForm").innerHTML = TANJAI.field("video") + `
    ...
    </div><div class="button-row"><button class="btn primary" id="makeVideo">✨ สร้างด้วย AI ผู้กำกับวิดีโอ</button><button class="btn secondary" id="saveVideo">บันทึก</button></div>`;
  $("#voiceForm").innerHTML = TANJAI.field("voice") + `
    ...
    </div><div class="button-row"><button class="btn primary" id="makeVoice">✨ สร้างด้วย AI เสียงพากย์</button><button class="btn secondary" id="saveVoice">บันทึก</button></div>`;
  $("#deckForm").innerHTML = TANJAI.field("deck") + `
    ...
    </div><div class="button-row"><button class="btn primary" id="makeDeck">✨ สร้างด้วย AI สไลด์</button><button class="btn secondary" id="saveDeck">บันทึก</button></div>`;
  ...
  // Results
  $("#imageResult").innerHTML = TANJAI.readyOutputShell("image", "ภาพพร้อมสร้าง — AI Poster Creative Director", "ขั้นตอน: คัดลอก Prompt → เปิด ทันใจ GPT → แนบไฟล์จริง (ถ้ามี) → วาง Prompt", "imageOut");
...
$("#mcResult").innerHTML = TANJAI.readyOutputShell("mc", "สคริปต์พิธีกรพร้อมใช้ — MC Writer", "คุมลำดับพิธี ชื่อ ตำแหน่ง คำเชื่อม และบัตรเตือนพิธีกร", "mcOut");
  ...
  TANJAI.updateImageResultMode = function(mode){
    ...
    const specialistMeta = TANJAI.state.lastImageSpecialistMeta || { title:"ภาพพร้อมสร้าง — AI Poster Creative Director", desc:"คัดลอก Prompt แล้วเปิด ทันใจ GPT หากเลือกไฟล์ในเว็บ ต้องแนบไฟล์จริงซ้ำในแชทก่อนวาง Prompt" };
    if(mode === "prompt"){
      TANJAI.setReadyOutput("image", {
        title:`Prompt มืออาชีพ — ${specialistMeta.role || "AI Poster Creative Director"}`,
    ...
    TANJAI.setReadyOutput("image", {
      title:specialistMeta.title || "ภาพพร้อมสร้าง — AI Poster Creative Director",
      desc:specialistMeta.desc || "คัดลอก Prompt แล้วเปิด ทันใจ GPT หากเลือกไฟล์ในเว็บ ต้องแนบไฟล์จริงซ้ำในแชทก่อนวาง Prompt",
      main:executeText,
  ...
  const v91CreativePresets = {
    ...
    "ข่าวประชาสัมพันธ์ / สรุปกิจกรรม": {
      contentType:"ข่าวประชาสัมพันธ์ / สรุปกิจกรรม",
      visualPreset:"ข่าวประชาสัมพันธ์แบบสรุปกิจกรรม",
      style:"PR Recap / Event Report Poster",
      layout:"Hero + Executive Strip + Photo Grid",
      density:"ข้อมูลเยอะ แต่อ่านง่าย",
      focus:"เน้นภาพกิจกรรม",
      colorTone:"ให้ AI เลือกให้เหมาะสม",
      tone:"ทางการ สุภาพ อ่านง่าย",
      mainCategory:"สรุปผลงาน / รายงานผล",
      subCategory:"ขอบคุณ / สรุปผล",
      preview:"งานแนวนี้เหมาะกับหัวข่าวเด่น ภาพบุคคลหรือองค์กรเด่น ภาพหลัก 1 ภาพ และกริดภาพย่อยหลายช่องแบบอ่านง่าย"
    },
    "สถาบันการศึกษา / กิจกรรมนักเรียน": {
      contentType:"ข่าวประชาสัมพันธ์ / สรุปกิจกรรม",
      visualPreset:"โปสเตอร์สถาบันการศึกษา",
      style:"Institutional PR / Education Premium",
      layout:"Header + Key Visual + Photo Grid",
      density:"ข้อมูลเยอะ แต่อ่านง่าย",
      focus:"เน้นภาพบุคคล",
      colorTone:"น้ำเงิน–ขาว ทางการ",
      tone:"ทางการ สุภาพ อ่านง่าย",
      mainCategory:"กิจกรรม / โครงการ / อบรม",
      subCategory:"ขอบคุณ / สรุปผล",
      preview:"งานสถาบันการศึกษาควรดูน่าเชื่อถือ ทันสมัย และจัดข้อมูลข่าวกิจกรรมอย่างเป็นระเบียบ"
    },
  ...
  const applyV91CreativePreset = (ctx, imageType, toast=true) => {
    ...
    syncImageSpecialist(false);
    refreshV91QualityPreview();
    if(toast) TANJAI.toast("ตั้งค่า Creative Quality ตามบริบทงานให้แล้ว");
  };


  const syncImageSpecialist = (forceToast=false) => {
    const specialistEl = $("#image-specialist");
    if(!specialistEl) return;
    if(specialistEl.dataset.userLocked === "1"){
      if(forceToast) TANJAI.toast("คงบทบาท AI ตามที่เลือกไว้แล้ว");
      return;
    }
    const visual = $("#image-visualPreset")?.value || "";
    const ctx = $("#image-workContext")?.value || "";
    const imageType = $("#image-imageType")?.value || "";
    const text = `${visual} ${ctx} ${imageType}`;
    let role = "AI Poster Creative Director";
    if(/สรุปกิจกรรม|ข่าวประชาสัมพันธ์|recap|Photo Grid|หลายภาพ/i.test(text)) role = "AI Event Recap Designer";
    else if(/การศึกษา|วิทยาลัย|โรงเรียน|นักเรียน|นักศึกษา/i.test(text)) role = "AI Education Poster Designer";
    else if(/อินโฟกราฟิก|Infographic|ขั้นตอน|ข้อมูลควรรู้/i.test(text)) role = "AI Infographic Planner";
    else if(/การ์ตูน|มาสคอต|Character/i.test(text)) role = "AI Character Visual Designer";
    else if(/เพลง|Cover|Cinematic|หนัง|แฟนตาซี/i.test(text)) role = "AI Cinematic Cover Director";
    else if(/ประกาศ|แจ้งข่าว|announcement/i.test(text)) role = "AI PR News Designer";
    setSelectOptionValue("#image-specialist", role);
    if(forceToast) TANJAI.toast(`ตั้งบทบาท AI เป็น ${role}`);
  };
  ...
  const setupV91CreativeQuality = () => {
    ...
    $("#image-workContext")?.addEventListener("change", () => { applyV91CreativePreset($("#image-workContext").value, null, false); syncImageSpecialist(false); });
    $("#image-imageType")?.addEventListener("change", () => { refreshV91QualityPreview(); syncImageSpecialist(false); });
    ...
    $("#image-specialist")?.addEventListener("change", event => { event.currentTarget.dataset.userLocked = event.currentTarget.value && !/^ให้ AI/.test(event.currentTarget.value) ? "1" : ""; refreshV91QualityPreview(); });
    ...
    $$("[data-v91-context]").forEach(btn => btn.addEventListener("click", () => {
      ...
      if(btn.dataset.v983Specialist){ const specialistEl = $("#image-specialist"); if(specialistEl){ specialistEl.dataset.userLocked = "1"; setSelectOptionValue("#image-specialist", btn.dataset.v983Specialist); }} else { const specialistEl = $("#image-specialist"); if(specialistEl) specialistEl.dataset.userLocked = ""; syncImageSpecialist(false); }
...
- เหมาะกับงานที่ต้องปล่อยหลายสื่อพร้อมกัน`
  ...
  $("#makeImage").onclick = () => {
    const showImageError = (error) => {
      console.error("TANJAI_IMAGE_PROMPT_ERROR", error);
      const message = error?.message || String(error || "Unknown error");
      const fallback = `ระบบสร้าง Prompt ขัดข้องชั่วคราว\n\nสาเหตุที่ตรวจพบ: ${message}\n\nวิธีแก้เร็ว:\n1. กด Ctrl + F5 เพื่อล้าง cache\n2. ลองกดสร้างอีกครั้ง\n3. หากยังขึ้นข้อความนี้ ส่งภาพหน้าจอนี้ให้ผู้พัฒนา`;
      try{
        TANJAI.setReadyOutput("image", {
          title:"ระบบสร้าง Prompt ขัดข้อง",
          desc:"ระบบดักข้อผิดพลาดไว้แล้ว จึงไม่เงียบค้างเหมือนเดิม",
          main:fallback,
          advancedTitle1:"ข้อมูลสำหรับตรวจแก้",
          advanced1:String(error?.stack || message)
        });
      }catch(renderError){
        const out = document.getElementById("imageOut");
        if(out) out.textContent = fallback;
      }
      TANJAI.toast?.("ระบบสร้าง Prompt ขัดข้อง — กรุณาลองรีเฟรชหน้า");
    };

    try{
      const d = getImageDataForPrompt();
      const critic = TANJAI.promptCritic ? TANJAI.promptCritic(d) : "สถานะ Prompt: พร้อมใช้";
      d.criticSummary = critic;

      const professionalOut = TANJAI.buildImageExpertPrompt
        ? TANJAI.buildImageExpertPrompt(d)
        : (TANJAI.discussPrompt ? TANJAI.discussPrompt("image", d) : "");

      const executeOut = TANJAI.executionPrompt
        ? TANJAI.executionPrompt("image", d)
        : (TANJAI.buildImageExecutionPrompt ? TANJAI.buildImageExecutionPrompt(d) : professionalOut);

      if(!executeOut || !String(executeOut).trim()){
        throw new Error("ไม่พบผลลัพธ์ Prompt จาก Image Engine");
      }

      TANJAI.state.lastImagePrompt = professionalOut || executeOut;
      TANJAI.state.lastImageGPT = executeOut;
      TANJAI.state.lastImage = executeOut;
      TANJAI.state.lastImageCritic = critic;
      TANJAI.state.lastImageSpecialistMeta = TANJAI.getImageSpecialistMeta ? TANJAI.getImageSpecialistMeta(d) : null;
      TANJAI.updateImageResultMode?.("gpt");

      // Hard fallback: ถ้า shell ไม่ render ด้วยเหตุใดก็ตาม ให้ใส่ข้อความลงกล่องโดยตรง
      const out = document.getElementById("imageOut");
      if(out && !out.textContent.trim()) out.textContent = executeOut;
...
Specialist Output Engine สร้างชุดสื่อพร้อมใช้ในเว็บก่อน โดยยังไม่เรียก API
...
- หากต้องการใช้ AI API จริง ค่อยส่ง Prompt ขั้นสูงต่อในภายหลัง
...
${TANJAI.outputDeliveryGuard("ชุดไฟล์สื่อ")}`;
    TANJAI.setReadyOutput("kit", {
      title:"ชุดสื่อพร้อมใช้ — Campaign Producer",
      desc:"สร้างแกนแคมเปญเดียว แล้วแตกเป็นภาพ โพสต์ วิดีโอ เสียง และสไลด์ โดยใช้สมองเฉพาะทางในเว็บ",
      main:out,

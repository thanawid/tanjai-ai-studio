...
<div class="section-title"><b>4</b><h4>การปกป้องภาพจริง</h4></div>
  ...
  $("#postForm").innerHTML = TANJAI.field("post") + `
    <div class="form-note">เมนูนี้เป็นครัวกลางของเนื้อหา ใช้เรียบเรียงข้อมูลดิบ รูปเอกสาร หรือรายละเอียดงาน ให้กลายเป็นสรุป โพสต์ สคริปต์เสียง สคริปต์คลิป และสคริปต์พิธีกร</div>
    <div class="post-mode-switch-v894" role="group" aria-label="เลือกโหมดเรียบเรียง">
      <button type="button" id="postModeContent" class="mode-pill-v894 active">✍️ เรียบเรียงทั่วไป</button>
      <button type="button" id="postModeMC" class="mode-pill-v894">🎤 งานพิธีกร</button>
    </div>
    <div class="form-section"><div class="section-title"><b>2</b><h4>ตั้งค่าการเรียบเรียงเนื้อหา</h4></div>
      <div class="form-grid">
        ...
        <label>ต้องการเรียบเรียงเป็น<select id="post-channel"><option>ครบชุด: สรุป + โพสต์ + สคริปต์เสียง + สคริปต์คลิป</option><option>สรุปใจความสำคัญ</option><option>โพสต์ Facebook / Line</option><option>สคริปต์เสียงบรรยาย</option><option>สคริปต์คลิปวิดีโอ</option><option>สคริปต์พิธีกร / ผู้ดำเนินรายการ</option><option>คำกล่าวรายงาน</option><option>คำกล่าวประธาน</option><option>Bullet สำหรับสไลด์</option><option>ข้อความสำหรับภาพประชาสัมพันธ์</option></select></label>
        ...
        <label class="full">แนบรูปประกอบ / รูปเอกสาร / รูปลงพื้นที่
          ...
          <small>หมายเหตุ: ถ้าเป็นภาพเอกสาร ให้นำ Prompt พร้อมรูปไปใช้กับ AI ที่วิเคราะห์ภาพได้ เช่น ChatGPT / Gemini แล้วให้ AI อ่านเอกสารก่อนสรุป</small>
          <div id="post-photoPreview" class="upload-preview-grid"></div>
        </label>
        <label class="full">สิ่งที่อยากให้เน้นเพิ่มเติม<textarea id="post-extra" placeholder="เช่น เน้นการรับฟังปัญหา / ลำดับพิธี / ประธานในพิธี / ผู้กล่าวรายงาน / ช่วงมอบรางวัล / ช่วงถ่ายภาพ / ข้อความเชิญบนเวที"></textarea></label>
      </div>
      <div class="summary-output-tabs">
        ...
        <span class="summary-chip">คำกล่าว</span>
...
$("#postResult").innerHTML = TANJAI.readyOutputShell("post", "Prompt โพสต์ — สั่งทำทันที", "คัดลอกแล้วให้ AI เขียนโพสต์ทันที พร้อม Prompt สำหรับแก้/คุยต่อ", "postOut");
  ...
  // v8.9.4 Command Palette + Separated Content/MC Modes
  TANJAI.quickActions = [
    ...
    {label:"เรียบเรียงเนื้อหา", icon:"✍️", view:"post", content:true, hint:"สรุปงาน โพสต์ สคริปต์เสียง สคริปต์คลิป"},
    {label:"งานพิธีกร", icon:"🎤", view:"post", mc:true, hint:"พิธีเปิด คำเชิญประธาน คำเชื่อมช่วง คำปิดงาน"},
  ...
  TANJAI.mountV82Navigation = function(){
    ...
    wrap.innerHTML = `
      ...
      <div id="fabMenu" class="fab-menu" hidden aria-hidden="true">
        ...
        <button data-fab-content="true" title="เรียบเรียงเนื้อหา">✍️<span>เนื้อหา</span></button>
        <button data-fab-mc="true" title="งานพิธีกร">🎤<span>พิธีกร</span></button>
      ...
      <nav class="mobile-tabbar" aria-label="เมนูลัดมือถือ">
        ...
        <button data-view="post" data-content-shortcut="true">✍️<span>เนื้อหา</span></button>
        <button data-view="post" data-mc-shortcut="true">🎤<span>พิธีกร</span></button>

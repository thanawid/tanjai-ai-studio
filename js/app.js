...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const toolOptions = {
    ...
    videoFormats: ["คลิปประชาสัมพันธ์","MV เพลง / Music Video","Lyric Video / วิดีโอเนื้อเพลง","นิทานเด็ก / Kids Story","หนังสั้น / Short Film","ซีรีส์สั้น / Short Series","โฆษณาสินค้า / Product Ad","คลิปรีวิวสินค้า / Review","สารคดีสั้น / Mini Documentary","การ์ตูน / Animation","TikTok / Reels / YouTube Shorts","คลิปข่าวด่วน","คลิปกิจกรรม / โครงการ","คลิปโซเชียลไวรัล"],
    videoAspectRatios: ["9:16 Vertical — TikTok / Reels / Shorts","16:9 Landscape — YouTube / Facebook / จอทีวี","1:1 Square — Feed / Ads","4:5 Portrait — Facebook / Instagram Feed","ให้ AI เลือกตามช่องทาง"],
    videoStyles: ["ให้ AI เลือกตามงาน","Cinematic Emotional","Modern Social Fast Cut","Warm Storytelling","Documentary Real Footage","Kids Friendly Colorful","Product Commercial Clean","Music Video Mood Visual","Lyric Video Readable Thai","Animation / Cartoon Direction"],
    videoOutputPacks: ["Short Prompt รายช็อต + เสียง CapCut (แนะนำ)","Production Pack ครบชุด","Storyboard + Voice Over","AI Video Prompt รายช็อต","CapCut Editing Plan","Lyric / MV Pack","Short Ads Pack"],
...
- เหมาะกับงานที่ต้องปล่อยหลายสื่อพร้อมกัน`
  ...
  $("#makeVideo").onclick = async () => {
    ...
    Object.assign(d, {length, format, channel, aspectRatio, videoStyle, outputPack});
    const team=TANJAI.freeWritingTeam;
    const aiResult=await TANJAI.generateWritingWithAI({
      tool:"video", data:d,
      options:{length, format, channel, aspectRatio, videoStyle, outputPack},
    ...
    TANJAI.setReadyOutput("video", {
      ...
      advanced2:TANJAI.executionPrompt("video", d, {length, format, channel, aspectRatio, videoStyle, outputPack})
    });

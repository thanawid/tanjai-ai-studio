...
$("#albumForm").innerHTML = `
  ...
  // Results
  $("#imageResult").innerHTML = TANJAI.readyOutputShell("image", "ภาพพร้อมสร้าง — V10 Smart Image", "สร้าง Prompt หรือกดสร้างภาพในเว็บได้ โดย AI เติมมุมสร้างสรรค์ได้แต่ไม่เดาข้อมูลจริง", "imageOut");
...
$("#mcResult").innerHTML = TANJAI.readyOutputShell("mc", "สคริปต์พิธีกรพร้อมใช้ — MC Writer", "คุมลำดับพิธี ชื่อ ตำแหน่ง คำเชื่อม และบัตรเตือนพิธีกร", "mcOut");
  ...
  TANJAI.updateImageResultMode = function(mode){
    ...
    TANJAI.setReadyOutput("image", {
      title:"ภาพพร้อมสร้าง — V10 Smart Image",
      desc:"คัดลอก Prompt หรือกดสร้างภาพในเว็บได้ หากมีไฟล์จริงและใช้เครื่องมือภายนอก ให้แนบไฟล์จริงซ้ำก่อนวาง Prompt",
      main:executeText,

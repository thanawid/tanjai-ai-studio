...
<div class="section-title"><b>4</b><h4>การปกป้องภาพจริง</h4></div>
    ...
    <div class="button-row"><button class="btn primary" id="makeImage">สร้าง Prompt ภาพ</button><button class="btn secondary" id="checkImageReady">ตรวจความพร้อม</button><button class="btn secondary" id="saveImage">บันทึก</button></div>
  `;
  ...
  // Results
  $("#imageResult").innerHTML = TANJAI.resultShell("image", "Prompt ภาพ", "คัดลอกไปใช้กับทันใจ GPT / Canva / AI สร้างภาพ พร้อมคำสั่งแนบไฟล์จริง", "imageOut", `<button class="btn primary" data-copybox="imageOut">คัดลอก Prompt ภาพ</button>`) + `<div class="critic-card"><div class="critic-head"><b>Prompt Critic</b><span>ตรวจงานก่อนส่ง</span></div><div id="imageCriticOut" class="result-box critic-box">กด “ตรวจความพร้อม” หรือ “สร้าง Prompt ภาพ” เพื่อดูคะแนนความพร้อม</div><div class="button-row"><button class="btn secondary" data-copybox="imageCriticOut">คัดลอกผลตรวจ</button></div></div>`;
  ...
  $("#checkImageReady").onclick = () => {
    const d = getImageDataForPrompt();
    const critic = TANJAI.promptCritic(d);
    $("#imageCriticOut").textContent = critic;
    TANJAI.toast("ตรวจความพร้อมแล้ว");
  };

...
/**
 * ===================================================
 * TANJAI AI Studio v9.3.5 — Professional Brief-to-Prompt Output
 * ===================================================
 * Purpose:
...
(function(){
  ...
  T.promptBrainReport = function(d = {}, tool = "image"){
    ...
    return `Professional Brief-to-Prompt Output v9.3.5
...
${T.proOutputFormat(tool, d, extra)}`;
  ...
  T.promptPack = function(d = {}){
    return `Professional Brief-to-Prompt Pack v9.3.5
...
- ถ้าข้อมูลไม่ครบ ให้เสนอช่องเว้นเติมภายหลัง`;
  ...
  T.promptCritic = function(d = {}, tool = "image"){
    ...
    return `Professional Output Check v9.3.5

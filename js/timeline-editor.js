...
(() => {
  ...
  function downloadPlan() {
    const plan={version:'11.6.7',title:state.title,aspect:state.aspect,totalDuration:totalDuration(),clips:state.clips.map((c,i)=>({order:i+1,name:c.name,trimStart:c.trimStart,trimEnd:c.trimEnd,look:c.look}))};

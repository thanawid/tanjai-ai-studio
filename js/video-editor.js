...
(() => {
  ...
  function install(){
    ...
    form.appendChild(document.createRange().createContextualFragment(`<div class="video-mode-switch" role="tablist"><button type="button" class="video-mode-btn" data-video-mode="script">📝 คิดบทก่อนถ่าย</button><button type="button" class="video-mode-btn active" data-video-mode="editor">🎬 เตรียมวิดีโอ</button></div>`));
  ...
  function editorHTML(){return `
    ...
    <div class="form-section">
      ...
      <div class="video-upload-summary" id="videoUploadSummary">ยังไม่มีคลิป</div><div class="video-clip-grid" id="videoClipGrid"></div>
    </div>
    <div class="form-section">
      ...
      <div class="form-grid">
        ...
        <label class="video-auto-enhance full"><input id="autoEnhance" type="checkbox" checked><span><b>ปรับคุณภาพคลิปอัตโนมัติ</b><small>ช่วยเลือกช่วงที่เหมาะสมและเตรียมคลิปให้พร้อมใช้งาน</small></span></label>
      </div>
      <div class="button-row"><button class="btn primary video-create-kit-btn" id="analyzeFootageBtn" type="button">✨ เตรียมวิดีโอให้เลย</button><button class="btn secondary" id="clearFootageBtn" type="button">ล้างคลิป</button></div>
  ...
  function resultHTML(){return `
    <div class="editor-result-head"><div><small>ทันใจ AI VIDEO ASSISTANT</small><h3>งานที่เตรียมไว้</h3><p id="editorResultStatus">เพิ่มคลิปและรายละเอียดของงาน</p></div><span class="editor-status-pill" id="editorStatusPill">รอคลิป</span></div>
    <div class="editor-stats" id="editorStats"></div>
    <details class="footage-insight-details" id="footageInsightDetails" hidden><summary>ดูรายละเอียดคลิป</summary><section class="footage-insight-panel" id="footageInsightPanel"></section></details>
    ...
    <div class="editor-export-box" id="editorExportBox" hidden><div><b>เลือกขั้นตอนถัดไป</b><small>ดาวน์โหลดคลิปที่เตรียมไว้ไปใช้เอง หรือส่งต่อให้ทันใจทำวิดีโอ</small></div><div class="button-row"><button class="btn primary" id="downloadSelectedClipsBtn" type="button">⬇ ดาวน์โหลดคลิปที่เตรียมไว้ (.ZIP)</button><button class="btn secondary" id="downloadClipListBtn" type="button">รายชื่อคลิป</button><button class="btn secondary" id="downloadEditPlanBtn" type="button">บันทึกแผนตัดต่อ</button><button class="btn secondary" id="prepareAutoEditBtn" type="button">ให้ทันใจทำวิดีโอให้</button></div><small class="export-help">ไฟล์ ZIP มีคลิปต้นฉบับที่คัดและเรียงลำดับแล้ว พร้อมสคริปต์และรายการตัดต่อ</small></div>`;}
  ...
  function bind(){
    ...
    $('#prepareAutoEditBtn')?.addEventListener('click',()=>TANJAI.toast('เตรียมชุดงานสำหรับทำวิดีโอต่อแล้ว'));
  }

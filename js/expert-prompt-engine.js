...
- ถ้าสร้างภาพไม่ได้ ให้ส่ง A–E ครบ ห้ามอ้างว่าสร้างไฟล์สำเร็จ และห้ามตอบเป็น path ภายใน
...
ห้ามแต่งข้อเท็จจริง และไม่ต้องแสดงกระบวนการคิดภายใน`;
  ...
  T.simplifyExpertForms = function(){
    ...
    if(kit){
      moveSections(kit,[/Campaign Director/]);
      renumberVisible(kit);
    }
    ...
    if(album){
      ...
      banner.innerHTML = "<b>QUICK MODE</b><span>ใส่ภาพหลัก + ภาพรอง + หัวข้องาน แล้วสร้างชุดภาพได้เลย</span>";

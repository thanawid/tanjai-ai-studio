...
TANJAI.routerSuggest = function(query = "") {
  ...
  }else if(has(/แต่งภาพ|ปรับภาพ|แก้ภาพมืด|ปรับแสง|เพิ่มความคม|batch photo|enhance|photo pro/)){ view = "photoPro"; reason = "โจทย์เน้นปรับคุณภาพภาพจริงหลายภาพโดยไม่สร้างภาพใหม่"; }

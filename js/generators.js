...
TANJAI.commonData = function(prefix) {
  ...
  const baseData = {
    ...
    specialist: v("specialist") || "ให้ AI เลือกตามงาน",
...
TANJAI.v91CreativePreset = function(context = "", imageType = "", d = {}) {
  ...
  if (has(/ข่าวประชาสัมพันธ์แบบสรุปกิจกรรม|สรุปกิจกรรมหลายภาพ|photo grid|recap|รายงานผล|ภาพรวมภายในงาน|ภาพบรรยากาศ|ปฐมนิเทศ|ต้อนรับนักศึกษาใหม่|นักศึกษาใหม่/)) {
    return {
      ...base,
      context: context || "ข่าวประชาสัมพันธ์ / สรุปกิจกรรม",
      imageType: imageType || "ภาพสรุปกิจกรรมหลายภาพ",
      style: "PR Recap / Event Report Poster",
      layout: "Hero + Executive Strip + Photo Grid",
      density: "ข้อมูลเยอะ แต่อ่านง่าย",
      focus: "หัวเรื่องเด่น ภาพหลักชัด และกริดภาพกิจกรรมหลายช่อง",
      colorTone: /การศึกษา|วิทยาลัย|โรงเรียน|นักเรียน|นักศึกษา/.test(text) ? "น้ำเงิน–ขาว ทางการ" : "ให้ AI เลือกให้เหมาะสม",
      visualTone: "น่าเชื่อถือ เป็นงานข่าวประชาสัมพันธ์จริง และดูเป็นระเบียบ",
      creativeDirection: "ออกแบบเป็นโปสเตอร์ข่าวประชาสัมพันธ์แบบสรุปกิจกรรม มีหัวข่าวเด่น ภาพบุคคลหรือหน่วยงานเด่นด้านบน ภาพกิจกรรมหลัก 1 ภาพ บล็อกสรุปข้อมูล และกริดภาพย่อย 4–9 ช่องเมื่อข้อมูลเอื้อ",
      textPolicy: "แบ่งข้อความเป็นบล็อกสั้น ๆ เช่น หัวเรื่อง วันที่ เนื้อหาสรุป และคำอธิบายภาพย่อย หลีกเลี่ยงประโยคยาว",
      overdoGuard: "ห้ามยัดข้อความจนล้นภาพ ห้ามแต่งชื่อคน ตำแหน่ง วันเวลา หรือจำนวนผู้เข้าร่วมเอง"
    };
  }

  if (has(/สถาบันการศึกษา|วิทยาลัย|โรงเรียน|นักเรียน|นักศึกษา/)) {
    return {
      ...base,
      context: context || "สถาบันการศึกษา / กิจกรรมนักเรียน",
      imageType: imageType || "โปสเตอร์ข่าวประชาสัมพันธ์",
      style: "Institutional PR / Education Premium",
      layout: "Header + Key Visual + Photo Grid",
      density: "ปานกลางถึงข้อมูลเยอะ แต่อ่านง่าย",
      focus: "ภาพลักษณ์องค์กร บุคคลสำคัญ และข่าวกิจกรรม",
      colorTone: "น้ำเงิน–ขาว ทางการ",
      visualTone: "ทางการ ทันสมัย น่าเชื่อถือ และเป็นมิตร",
      creativeDirection: "ให้ภาพมีความเป็นสถาบันการศึกษา มืออาชีพ และเหมาะกับการประชาสัมพันธ์จริง",
      textPolicy: "หัวข้อเด่น รองลงมาคือเนื้อหาสรุป วันเวลา สถานที่ และบล็อกภาพกิจกรรม",
      overdoGuard: "ห้ามใส่โลโก้ปลอม ห้ามทำภาพหรูเกินจริง และห้ามใส่ข้อความยาวจนแน่นเกิน"
    };
  }
...
TANJAI.getImageSpecialistMeta = function(d = {}, brief = null){
  const b = brief || TANJAI.v91BuildSharedBrief(d, "image");
  const selected = String(d.specialist || "").trim();
  const text = `${selected} ${d.visualPreset || ""} ${d.contentType || ""} ${d.workContext || ""} ${d.imageType || ""} ${d.title || ""} ${d.detail || ""}`;
  const choose = (role, title, desc, checks=[]) => ({ role, title, desc, checks });
  if(selected && !/^ให้ AI/.test(selected)){
    if(/Event Recap|สรุปกิจกรรม|Recap/i.test(selected)) return choose("AI Event Recap Designer","ภาพพร้อมสร้าง — AI Event Recap Designer","ถนัดงานข่าวประชาสัมพันธ์แบบสรุปกิจกรรม ภาพหลัก + กริดภาพย่อย + บล็อกข้อมูล",["จัดลำดับหัวข่าวให้เด่น","ใช้กริดภาพย่อยอย่างมีระเบียบ","ข้อความสั้น อ่านง่ายบนมือถือ"]);
    if(/Education|การศึกษา/i.test(selected)) return choose("AI Education Poster Designer","ภาพพร้อมสร้าง — AI Education Poster Designer","ถนัดโปสเตอร์สถาบันการศึกษา ข่าวกิจกรรม ปฐมนิเทศ และภาพลักษณ์องค์กร",["โทนทางการทันสมัย","บุคคลสำคัญและหัวข้อเด่นต้องบาลานซ์","ส่วนข้อมูลวัน/สถานที่ต้องชัดเมื่อมีจริง"]);
    if(/Infographic/i.test(selected)) return choose("AI Infographic Planner","ภาพพร้อมสร้าง — AI Infographic Planner","ถนัดจัดข้อมูลหลายบล็อกให้อ่านง่ายและเป็นระบบ",["ลำดับข้อมูลชัด","ไม่ยัดข้อความเกินจำเป็น","มี hierarchy ของหัวข้อ"]);
    if(/Character/i.test(selected)) return choose("AI Character Visual Designer","ภาพพร้อมสร้าง — AI Character Visual Designer","ถนัดงานการ์ตูน คาแรกเตอร์ และภาพสื่อสารแบบสนุก",["คุมคาแรกเตอร์ให้ชัด","สีและอารมณ์ตรงกลุ่มเป้าหมาย","ข้อความไม่แย่งซีนภาพ"]);
    if(/Cinematic|Cover/i.test(selected)) return choose("AI Cinematic Cover Director","ภาพพร้อมสร้าง — AI Cinematic Cover Director","ถนัดปกผลงาน โปสเตอร์หนัง และภาพอารมณ์เด่น",["ภาพนำอารมณ์","ข้อความน้อยแต่คม","ใช้แสงและ mood ชัด"]);
    if(/News|PR/i.test(selected)) return choose("AI PR News Designer","ภาพพร้อมสร้าง — AI PR News Designer","ถนัดงานประกาศและข่าวประชาสัมพันธ์ที่ต้องอ่านเร็ว เชื่อถือได้",["หัวข้อชัด","ข้อมูลจริงเท่านั้น","ไม่รกและไม่เว่อร์"]);
  }
  if(/สรุปกิจกรรม|ข่าวประชาสัมพันธ์|recap|Photo Grid|หลายภาพ|ปฐมนิเทศ|กิจกรรมนักเรียน/i.test(text)) return choose("AI Event Recap Designer","ภาพพร้อมสร้าง — AI Event Recap Designer","ระบบเลือกผู้เชี่ยวชาญงานสรุปกิจกรรมให้แล้ว เพื่อคุมภาพหลัก ภาพย่อย และบล็อกสรุป",["มีภาพหลัก + กริดภาพย่อย","บล็อกข้อมูลเป็นข่าว","เหมาะกับงานสรุปกิจกรรมจริง"]);
  if(/วิทยาลัย|โรงเรียน|การศึกษา|นักเรียน|นักศึกษา/i.test(text)) return choose("AI Education Poster Designer","ภาพพร้อมสร้าง — AI Education Poster Designer","ระบบเลือกผู้เชี่ยวชาญงานการศึกษาให้แล้ว เพื่อคุมภาพลักษณ์และสารทางการ",["ภาพบุคคลเด่นแต่ไม่แน่นเกิน","ข่าวกิจกรรมอ่านง่าย","เหมาะกับหน่วยงานการศึกษา"]);
  if(/อินโฟกราฟิก|Infographic|ขั้นตอน|ข้อมูลควรรู้/i.test(text)) return choose("AI Infographic Planner","ภาพพร้อมสร้าง — AI Infographic Planner","ระบบเลือกผู้เชี่ยวชาญด้านการจัดข้อมูลแล้ว",["โครงข้อมูลชัด","มองแล้วเข้าใจเร็ว","ไม่ใส่ข้อความฟุ่มเฟือย"]);
  if(/ประกาศ|แจ้งข่าว|เตือน/i.test(text)) return choose("AI PR News Designer","ภาพพร้อมสร้าง — AI PR News Designer","ระบบเลือกผู้เชี่ยวชาญด้านประกาศและข่าวแล้ว",["อ่านเร็ว","ข้อมูลจริงเท่านั้น","ไม่ยัดกราฟิก"]);
  if(/การ์ตูน|มาสคอต|คาแรกเตอร์/i.test(text)) return choose("AI Character Visual Designer","ภาพพร้อมสร้าง — AI Character Visual Designer","ระบบเลือกผู้เชี่ยวชาญคาแรกเตอร์แล้ว",["ภาพเด่น","คาแรกเตอร์ชัด","ข้อความน้อย"]);
  if(/เพลง|Cover|Cinematic|หนัง|แฟนตาซี/i.test(text)) return choose("AI Cinematic Cover Director","ภาพพร้อมสร้าง — AI Cinematic Cover Director","ระบบเลือกผู้เชี่ยวชาญภาพแนว mood / cover แล้ว",["บรรยากาศเด่น","ข้อความคม","คุมอารมณ์ภาพ"]);
  return choose("AI Poster Creative Director","ภาพพร้อมสร้าง — AI Poster Creative Director","ระบบใช้ผู้กำกับภาพรวม เพื่อจัดสารและเลย์เอาต์ให้เหมาะกับงาน",["คุมสารหลัก","อ่านง่ายบนมือถือ","บาลานซ์ระหว่างภาพกับข้อความ"]);
};
...
TANJAI.imagePrompt = function(d, outputMode = "gpt") {
  ...
  const specialist = TANJAI.getImageSpecialistMeta(d, b);
  
  return `${TANJAI.v9ExecutionHeader("ให้สร้างภาพตามข้อมูลด้านล่าง โดยแยกส่วนเนื้อหาและสไตล์ภาพออกจากกันอย่างชัดเจน")}

[0] ผู้เชี่ยวชาญ AI ที่ต้องรับบท:
- Specialist Role: ${specialist.role}
- หน้าที่หลัก: ${specialist.desc}
- สิ่งที่ต้องคุมเป็นพิเศษ: ${specialist.checks.join(" / ")}
...
- Visual Preset ที่เลือก: ${d.visualPreset || "ให้ AI เลือกตามงาน"}
- ผู้เชี่ยวชาญ AI ที่กำกับงาน: ${specialist.role}
...
3. คำว่า Visual Preset, PR Recap, Photo Grid, Cinematic, 3D, Infographic หรือชื่อ Specialist เป็นคำสั่งด้านสไตล์และวิธีทำงาน ห้ามพิมพ์เป็นข้อความบนภาพ

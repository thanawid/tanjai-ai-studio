...
TANJAI.discussPrompt = function(type, d){
  const taskNames = {image:"ภาพประชาสัมพันธ์",post:"โพสต์ / แคปชั่น",video:"วิดีโอ / Storyboard",voice:"สคริปต์เสียง",deck:"สไลด์",kit:"Prompt Pack"};
...
${TANJAI.guardBlock(d)}`;
  ...
  if(type === "post"){
    return `${TANJAI.executionIntro("เขียนโพสต์ Facebook / Line พร้อมแคปชั่น", "ส่งข้อความโพสต์พร้อมใช้แทน")}

งานเฉพาะ: โพสต์
ให้เขียนโพสต์ทันที ขอข้อความพร้อมคัดลอกไปใช้งาน ไม่ต้องอธิบายขั้นตอน
...
1) โพสต์หลักสำหรับ Facebook / Line
2) แคปชั่นสั้น 1 แบบ
3) ข้อความ Line OA แบบกระชับ 1 แบบ
4) Hashtag ที่เหมาะสม

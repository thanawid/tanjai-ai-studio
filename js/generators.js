...
TANJAI.discussPrompt = function(type, d){
  const taskNames = {image:"ภาพประชาสัมพันธ์",post:"เรียบเรียงเนื้อหา / สคริปต์",video:"วิดีโอ / Storyboard",voice:"สคริปต์เสียง",deck:"สไลด์",kit:"Prompt Pack"};
...
${TANJAI.guardBlock(d)}`;
  ...
  if(type === "post"){
    const target = d.channel || "ครบชุด";
    const workType = d.workType || "ไม่ระบุ";
    const isMC = /พิธีกร|ผู้ดำเนินรายการ|พิธีเปิด|พิธีปิด|คำกล่าว|ประธาน|กล่าวรายงาน/.test(`${target} ${workType} ${d.detail}`);
...
1) สคริปต์กล่าวต้อนรับ / เปิดช่วงพิธีกร
2) คำกล่าวแนะนำวัตถุประสงค์งานแบบสั้น
3) คำเชิญประธานในพิธี
4) คำเชิญผู้กล่าวรายงานหรือผู้เกี่ยวข้อง หากมีข้อมูล
5) คำพูดเชื่อมช่วงกิจกรรม / มอบรางวัล / ถ่ายภาพ / พักเบรก หากเหมาะสม
6) สคริปต์ปิดช่วง / ขอบคุณแขกผู้มีเกียรติ
7) หมายเหตุสำหรับพิธีกร เช่น จุดเว้นจังหวะ น้ำเสียง คำที่ต้องออกเสียงชัด
...
${TANJAI.guardBlock(d)}`;
    ...
    return `${TANJAI.executionIntro("เรียบเรียงเนื้อหา / เขียนสคริปต์พร้อมใช้", "ส่งข้อความเรียบเรียงพร้อมใช้แทน")}

งานเฉพาะ: เรียบเรียงเนื้อหา
ให้เรียบเรียงเนื้อหาทันทีจากข้อมูลด้านล่าง
ห้ามตอบเป็นเพียงการสรุปบรีฟ
ห้ามถามยืนยันก่อน
...
3) แคปชั่นสั้น
4) สคริปต์เสียงบรรยาย 1 นาที
5) สคริปต์คลิปวิดีโอสั้น
6) ข้อความสำหรับภาพประชาสัมพันธ์

...
กรุณาสร้างภาพประชาสัมพันธ์จริงทันทีจากข้อมูลนี้ สำหรับ ${orgName} ในขนาด ${size} โดยใช้สไตล์ ${style} โทนสี ${colorTone} และจัดวางให้เหมาะกับงานสื่อสารองค์กร / โซเชียล / แบรนด์ หากมีโลโก้ QR Code หรือภาพแนบในแชทนี้ ให้ใช้อ้างอิงจากไฟล์แนบดังกล่าว`;
